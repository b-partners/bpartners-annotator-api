...
import api.bpartners.annotator.endpoint.event.consumer.model.ConsumableEventTyper;
...
public class ConsumableEventTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new TypedEvent("api.bpartners.annotator.endpoint.event.model.UuidCreated", payload);
