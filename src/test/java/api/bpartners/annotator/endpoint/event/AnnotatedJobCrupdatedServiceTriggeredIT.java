...
import api.bpartners.annotator.service.event.AnnotatedJobCrupdatedService;
...
public class AnnotatedJobCrupdatedServiceTriggeredIT extends FacadeIT {
  @Autowired AnnotatedJobCrupdatedService subject;
